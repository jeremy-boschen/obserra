...
import { ServiceInfo } from "@/graphql/generated";
      ...
      <CardContent className="p-6">
        ...
        <div className="mt-4">
          ...
          <div className="flex items-center mt-1">
            <div className="text-xs font-medium text-gray-700 dark:text-gray-300 w-32">
              {metricsInsight?.memory?.used && metricsInsight?.memory?.maxHeap ? (
                <>
                  {metricsInsight.memory.used} of {metricsInsight.memory.maxHeap}
                </>
              ) : (
                <>-- / -- MB</>
              )}
        ...
        <div className="mt-3">
          ...
          <div className="flex items-center mt-1">
            <div className="text-sm font-medium text-gray-700 dark:text-gray-300 w-32">
              {metricsInsight?.cpu?.processUsage !== undefined &&
              metricsInsight.cpu.processUsage !== null ? (
        ...
        <div className="mt-3">
          ...
          <div className="text-sm font-medium text-gray-700 dark:text-gray-300">
            {metricsInsight?.uptime?.uptime ??
              (service.updated ? formatUptime(new Date(service.updated)) : "--")}
          </div>
        </div>
      </CardContent>
    </Card>
