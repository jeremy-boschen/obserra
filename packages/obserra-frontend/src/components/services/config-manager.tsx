...
const PropertyTypeEnum = z.enum(["STRING", "NUMBER", "BOOLEAN", "ARRAY", "MAP", "JSON", "YAML"]);
...
export function ConfigManager({ serviceId }: ConfigManagerProps) {
  ...
  const propertiesBySource = configProperties.reduce(
    (acc, property) => {
      ...
      <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Update this configuration property.</DialogDescription>
          </DialogHeader>
          <Form {...editForm}>
