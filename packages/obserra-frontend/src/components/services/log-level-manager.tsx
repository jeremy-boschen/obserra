                      ...
                      loggersList.map((logger) => (
                        <TableRow key={logger.name}>
                                  ...
                                  <div className="inline-block">
                                    <Select
                                      ...
                                      onValueChange={(newLevel) =>
                                        handleSetLogLevel(logger.name, newLevel)
                                      }
                                      ...
                                      <SelectTrigger className="h-7 px-2 py-0 border-none bg-transparent hover:bg-muted">
                                        <SelectValue placeholder="Select level">
                                          {logger.configuredLevel ? (
                                            <Badge
                                              variant="outline"
                                              className={getLogLevelColor(logger.configuredLevel)}
                                            >
                                              {logger.configuredLevel}
                                            </Badge>
                                          ) : (
                                      ...
                                      <SelectContent>
                                        {logLevels.map((level: string) => (
                                          <SelectItem key={level} value={level}>
                                            <Badge
                                              variant="outline"
                                              className={getLogLevelColor(level || "INFO")}
                                            >
                                              {level}
                                            </Badge>
                                          </SelectItem>
                          ...
                          <TableCell>
                            <Badge
                              variant="outline"
                              className={getLogLevelColor(logger.effectiveLevel)}
                            >
