...
public class KubernetesServiceDiscovery {
    ...
    private void registerService(V1Pod pod, V1Service k8sService, String appName) {
        ...
        Optional<ObService> existingService = storage.getServiceByPodName(podName);
        ...
        ObService service = new ObService();
        service.setName(appName);
        service.setNamespace(namespace);
        service.setPodName(podName);
        service.setStatus(ObServiceStatus.UNKNOWN);
...
//        service.setConfigPath("/actuator/env");
        ...
        ObService registeredService = storage.createService(service);
