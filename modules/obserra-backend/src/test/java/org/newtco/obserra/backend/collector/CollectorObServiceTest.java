...
class CollectorObServiceTest {

    private CollectorServiceImpl           collectorService;
    private Storage                        storage;
    private CollectionProperties           collectionProperties;
    private ObService                      service1;
    private ObService                      service2;
    @Mock
    ...
    void testCollectAllDataPeriodicallyInBackground_schedulesAndInvokesRunServices() {
        ...
        List<ObService> services = List.of(service1, service2);
