...
public class CollectorUtils {
   ...
   public static CollectionException fromConnectionError(Service service, Collector<?> collector, Exception e) {
     ...
     */
    public static ResponseErrorHandler collectorHttpErrorHandler(Service service, Collector<?> collector) {
        return new CollectorErrorHandler(service.getName(), collector.type());
    }
