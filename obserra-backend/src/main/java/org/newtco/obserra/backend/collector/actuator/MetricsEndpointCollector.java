 ...
 */
@Component
public class MetricsEndpointCollector implements ActuatorCollector<Object> {
    @Override
    ...
    @Override
    public Collector.State<Object> collect(Service service, ActuatorEndpoint actuatorEndpoint) {
